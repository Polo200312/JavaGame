...
public class MainMenuView extends GameStateView {
    ...
    public void initialize(Graphics2D graphics) {
        ...
        mySoundManager.load("changeItem","resources/audio/menu-item-activate.ogg",false);
        mySoundManager.load("selectNewGame","resources/audio/menu-new-view.ogg",false);
        ...
        inputKeyboard.registerCommand(265, true, (double elapsedTime) -> {
            currentSelection = currentSelection.previous();
            mySoundManager.play("changeItem");
        });
        ...
        inputKeyboard.registerCommand(GLFW_KEY_ENTER, true, (double elapsedTime) -> {
            nextGameState = switch (currentSelection) {
                case NewGame -> {
                    mySoundManager.play("selectNewGame");
    ...
    private float renderMenuItem(Font font, String text, float top, float height, Color color) {
        ...
        graphics.drawTextByHeight(font, text, 0.0f - width / 2, top, height, Misc.LAYER_MENU, color);
